...
public class DriverDealExtreme implements DriverPort {
    ...
    private static final Integer MAX_PAG = 15;

    public List<SunGlass> obtainSunGlass(final String path) {
        ...
        while (pos < MAX_PAG) {
            ...
            doc = getDocument(replacePage(path, pos));
    ...
    private String replacePage(String path, Integer pos) {
        return path.replace("&PageIndex=1", "&PageIndex=" + pos);
    }
